export class Sheep {
    ...
    getQuadValue(p0, p1, p2, t) { // quadratic bezier curve 공식 검색 참고
    ...
    getPointOnQuad(x1, y1, x2, y2, x3, y3, t) {
        ...
        const rotation = -Math.atan2(tx, ty) + (90 * Math.PI / 180) // 수직을 구하는 내장 함수
        return {
    ...
    quadTangent(a, b, c, t) { // 양의 각도를 조정하기 위한 공식 
